import { isRedisConfigured, redisGet, redisIncr, redisSet } from "@/lib/redis";
...
export async function checkOtpSendThrottle(email: string, maxPerHour = 5): Promise<boolean> {
