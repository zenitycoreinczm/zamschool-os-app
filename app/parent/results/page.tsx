...
export default function ParentResultsPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      const params = selectedChild ? `?studentId=${selectedChild}&groupBy=exam` : "?groupBy=exam";
      ...
      {error ? (
        ...
        <div className="space-y-4">
          {exams.map((exam, idx) => {
            ...
            return (
              <div key={`${exam.examTitle}-${exam.studentName}-${idx}`} className="rounded-xl border border-slate-200 bg-white shadow-sm">
                <button
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-500">
                        {exam.studentName} · {exam.className} · {exam.subjects.length} subjects
                      </div>
                    </div>
                  </div>
